...
<img src="{{asset('images/voorblad-blusmiddelen.jpg')}}" style="width: 900px;">
</div>
...
<table style="margin-left: 50px;">
	...
	<td style="width: 250px;vertical-align: top;border-right: 1px solid #cccccc">
		<table>
			...
			<tr><td><img src="{{asset('images/bco.png')}}" style="width: 200px;" ></td></tr>
		</table>	
	</td>
...
<td>info@bcobrandpreventie.nl</td>
</tr>
<tr>
<td style="width: 20px;">W:</td>
<td>www.bcobrandpreventie.nl
</td>
</tr>
</table>
</td>
...
<th style="width: 35px">Locatie</th> 
<th style="width: 85px">Merk</th> 
<th style="width: 115px">Blusstof</th> 
<th style="width: 115px">Type</th> 
<th style="width: 30px">Fab. Jaar</th> 
<th style="width: 30px">Afgeperst</th>
<th style="width: 30px">Debiet (l/min)</th> 
...
<td><?php if ($row['last_sealed'] == 0) { echo "-";} else { echo $row['last_sealed'];} ?></td>
<td><?php if ($row['debiet_measure'] == 0) { echo "-";} else { echo $row['debiet_measure'];} ?></td>
