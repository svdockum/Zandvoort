                    ...
                    <div class="medium-4 columns">
                       ...
                       <select id="etage" name="etage">
                        ...
                        <select id="fixednotes" name="fixednotes">
                            <option value="-">-</option>
                            <option>5-jaarlijks onderhouden conform NEN2559</option>
                            <option>Vervangen ivm revisiedatum (10 jaar)</option>
                         </select>
                    </div>
                    <div class="medium-4 columns">
                        ...
                        <label for="material" style="margin-top: 1rem;">Type</label>
...
$('body').on('click', 'a.editbtn', function(event) {
    ...
    var mat = '';
     Object.keys(row).forEach(function(nkey,index) {
        ...
        //save value of brandtype material for end use.
        //|| nkey == 'brand' || nkey == 'type' || nkey == 'material'
        if (nkey=="brand") {
            br = row[nkey].replace("&#039;", "'"); ;
        }       
        if (nkey=="type") {
        ...
        if (nkey=="material") {
            mat = row[nkey].replace("&#039;", "'"); ;
        }       


         if (nkey=="last_sealed" || nkey == 'fabrication_year') {
    ...
    $("#brand option").removeAttr("selected").trigger('change');
              //check of hij bestaat
               
              if ($('#brand option:contains("'+ br + '")').length > 0) {
                ...
                console.log('adding option');
                $('#brand').append('<option selected>'+row['brand']+'</option>').trigger('change');   
                            
               }

               $("#type option").removeAttr("selected").trigger('change');
              //check of hij bestaat
               
              if ($('#type option:contains("'+ t + '")').length > 0) {
                ...
                console.log('adding option');
                $('#type').append('<option selected>'+row['type']+'</option>').trigger('change');   
                            
               }



               $("#material option").removeAttr("selected").trigger('change');
              //check of hij bestaat
               
              if ($('#material option:contains("'+ mat + '")').length > 0) {
                ...
                console.log('adding option');
                $('#material').append('<option selected>'+row['material']+'</option>').trigger('change');   
...
function fillBrands() {
    //$.get( "<?php echo url('data/blus/brands') ?>", function( data ) {
        console.log('-----');console.log(brandListArray);console.log(typeListArray);
    $("#type").select2({ 
        data:typeListArray,
        createSearchChoice:function(term, data) { 
        if ($(data).filter(function() { 
...
function loaddropdownData() {
 ...
 var url = '<?php echo url('data/blus/brands') ?>';
   ...
   console.log('brandlist'+brandListArray);
