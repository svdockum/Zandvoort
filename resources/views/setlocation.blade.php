            ...
            <div class="small-12 columns">
                <div class="row align-middle">
                    ...
                    <div class="small-3 columns">
                         <a href="{{ url('/setlocation/' . $report->id . '/location/' . $location->id) }}" class="button large @if ($type == 'blusmiddelen') alert @endif @if ($type == 'keerkleppen') blue @endif @if ($type == 'noodverlichting') bggreen @endif">Selecteer Locatie <i class="fa fa-btn fa fa-caret-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
